					...
					<table width="100%" border="0" cellspacing="0" style="margin-top:30px">
						...
						<tr>
							<td class="listtd">
								...
								&nbsp;&nbsp;&nbsp;&nbsp; 
								<a href="${pageContext.request.contextPath}/client/logout">用户退出</a>
							</td>
						</tr>
					</table>
				</td>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<c:forEach items="${orders}" var="order">
										<tr>
											...
											<td class="tableopentd02">${order.buyerName }</td>
											<td class="tableopentd02">${order.ordertime}</td>
											<td class="tableopentd02">${order.purchased==0?"未支付":"已支付"}</td>
