    ...
    <div id="section">
        <div id="nav">
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/getAllTomaru">浏览时间统计</a></li>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td height="22" align="center" bgColor="#f5fafe" class="ta_01">
                                            收件人：</td>
                                        <td class="ta_01" bgColor="#ffffff">
                                            <input type="text" name="buyerName" size="15" value="" id="Form1_userName" class="bg" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="right" bgColor="#ffffff" class="ta_01">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                            <button><a href="${pageContext.request.contextPath}/admin/login/home.jsp">退出</a></button>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table cellspacing="0" cellpadding="1" rules="all"
                                    ...
                                    <c:forEach items="${orders}" var="order">
                                        <tr onmouseover="this.style.backgroundColor = 'white'"
                                            ...
                                            <td style="CURSOR: hand; HEIGHT: 22px" align="center" width="10%">${order.buyerName}</td>
                                            <td style="CURSOR: hand; HEIGHT: 22px" align="center" width="15%">${order.buyerAddress }</td>
                                            <td style="CURSOR: hand; HEIGHT: 22px" align="center" width="10%">${order.buyerTel }</td>
                                            <td style="CURSOR: hand; HEIGHT: 22px" align="center">${order.money}</td>
                                            <td width="8%" align="center">${order.user.username}</td>
                                            <td width="10%" align="center">${order.purchased==0?"未支付":"已支付"}</td>
